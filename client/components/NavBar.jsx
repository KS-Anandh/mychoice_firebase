...
const NavBar = ({user,setUser,userInfo,nav,setNav}) => {
    ...
    const RegSub=()=>{
        if(userName!=null && password!=null && userName!=" " && password!=" "){
            ...
            if(domine==="gmail.com"){
                axios.post("https://mychoice-firebase.vercel.app/mychoice/users/",{userName,password})
                .then((res)=>{
                    alert(res.data)
                })
                .catch((err)=>[
    ...
    <div className='navBar'>
        ...
        <div className='registration' id="reg">
               ...
               <div className='form'>
                ...
                <input type='checkbox'/><span style={{color:"grey"}}> I agree with terms and privacy policy</span>
